...
from architectures import VGGClassifier, FCCLayerClassifier, BaselineClassifier, NewClassifier
...
class ClassifierNetworkGraph:
    def __init__(self, input_x, target_placeholder, dropout_rate,
        ...
        if network_name == "New_classifier":
            self.c = NewClassifier(self.batch_size, name="classifier_neural_network",
