...
python cifar100_network_trainer.py --batch_size 128 --epochs 25 --experiment_prefix BranchTest --dropout_rate 0.65 --batch_norm_use True --strided_dim_reduction False --seed 1408714
